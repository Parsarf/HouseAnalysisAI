...
class LiabilityBlock(ContractModel): confirmed: Decimal|None=Decimal(0); potential: Decimal|None=Decimal(0); maximum: Decimal|None=Decimal(0); breakdown: list[dict[str,Any]]=[]
